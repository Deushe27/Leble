        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#"><img alt="Brand" src="../assets/img/logo.png" width="20"></a>
                ...
                <div class="col-sm-12 text-center">
                  <div class="embed-responsive embed-responsive-16by9">
                      <video class="embed-responsive-item" controls>
                              <!-- Use a placeholder for the source tag, we'll set it dynamically -->
                            <source id="videoPlayer" src="https://firebasestorage.googleapis.com/v0/b/leble-7f668.appspot.com/o/video%2Fvideo.mp4?alt=media&token=c09235cc-d649-4c3c-b946-28f29157b6af" type="video/mp4">
                        </video>
                      </div>
                  </div>
                    <div class="col-sm-12 text-center">
                        <h1>Apakah Anda akan memulai Kuis?</h1>
