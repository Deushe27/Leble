          ...
          <div class="container-fluid">
            <div class="navbar-header">
              <a class="navbar-brand" href="#">
                <img alt="Brand" src="../assets/img/logo.png" width="20">
              </a>
            </div>
          </div>
        </nav>
      ...
      <div class="isi">
        <div class="jumbotron">
          <div id="kontenku">
              <div class="row">
                  <div class="col-sm-12">
                    <img src="../assets/img/logo-leble.png" alt="../assets/img/logo.png" class="img img-responsive imgku">
                    <br>
                  </div>
